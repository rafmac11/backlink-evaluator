export async function POST(req) {
  try {
    ...
    const backlinks = bl ? {
      ...
      referring_domains_nofollow: bl.referring_domains_nofollow ?? 0,
      dofollow_domains: (bl.referring_domains ?? 0) - (bl.referring_domains_nofollow ?? 0),
      rank: bl.rank ?? 0,
      broken_backlinks: bl.broken_backlinks ?? 0,
    } : null;
